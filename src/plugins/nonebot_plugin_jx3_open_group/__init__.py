...
# 数据存储路径
root_dir = "data"
data_dir = root_dir + "/nonebot_plugin_jx3_open_group"
data_path = ""
...
async def _(bot: Bot, event: GroupMessageEvent, msg: Message = CommandArg()):
    ...
    try:
        ...
        async with get_new_page(viewport={"width": 1100, "height": 100}) as page:
            ...
            temp_path = "./data/nonebot_plugin_jx3_open_group/index" + await get_current_timestamp_seconds() + ".png"
    ...
    try:
        ...
        if flag:
            ...
            async with get_new_page(viewport={"width": 1100, "height": 100}) as page:
                ...
                await asyncio.sleep(1)
                temp_path = "./data/nonebot_plugin_jx3_open_group/list" + await get_current_timestamp_seconds() + ".png"
                pic = await page.screenshot(full_page=True, path=temp_path)
